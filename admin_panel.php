...
<body>
    ...
    <div class="container">
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<table border='1'>";
            echo "<tr><th>Mã NV</th><th>Tên NV</th><th>Giới tính</th><th>Nơi Sinh</th><th>Mã Phòng</th><th>Lương</th><th>Chức Năng</th></tr>";
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<a href='add_employee.php'>Thêm</a> | "; // Liên kết thêm nhân viên
                echo "<a href='delete_employee.php?id=" . $row["Ma_NV"] . "'>Xoá</a> | "; // Liên kết xoá nhân viên
                echo "<a href='edit_employee.php?id=" . $row["Ma_NV"] . "'>Sửa</a>"; // Liên kết sửa thông tin nhân viên
                echo "</td>";
                echo "</tr>";
            }
            echo "</table>";
        ...
        for ($trang = 1; $trang <= $soTrang; $trang++) {
            $active_class = ($trang == $trangHienTai) ? 'active' : '';
            echo "<a href='index.php?trang=$trang' class='$active_class'>$trang</a> ";
        }
        echo "</div>";
